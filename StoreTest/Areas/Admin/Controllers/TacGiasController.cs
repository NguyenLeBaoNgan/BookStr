...
namespace StoreTest.Areas.Admin.Controllers
{
    public class TacGiasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Image,IsDeleted")] TacGia tacGia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Image,IsDeleted")] TacGia tacGia)
        {
            if (ModelState.IsValid)
            {
                tacGia.IsDeleted = false;
